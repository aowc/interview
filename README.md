# IRT Python Programming Interview Exercise
...
* For this first part of the exercise, you can assume the input data will be consistent with [the example](data/weather_chicago.csv)
...
* If you add Python packages to the project, be sure to add them to the [environment file](environment.yml), otherwise we won't be able to run your code
